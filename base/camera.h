...
class PinholeCameraModel : public BaseCameraModel {
 ...
 public:
  ...
  inline void set_homography_params(const Eigen::Matrix3f& params) {
    homography_params_ = params;
  }

 inline Eigen::Matrix3f get_homography_params() const {
    return homography_params_;
  }
  ...
  */
  ...
  Eigen::Matrix3f homography_params_;  
};
