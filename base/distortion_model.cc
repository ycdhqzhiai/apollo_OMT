...
BrownCameraDistortionModel::get_camera_model() {
  ...
  camera_model->set_homography_params(homography_params_);
...
bool BrownCameraDistortionModel::set_params(size_t width, size_t height,
  ...
  homography_params_(0, 0) = params(14);
  homography_params_(0, 1) = params(15);
  homography_params_(0, 2) = params(16);
  homography_params_(1, 0) = params(17);
  homography_params_(1, 1) = params(18);
  homography_params_(1, 2) = params(19);
  homography_params_(2, 0) = params(20);
  homography_params_(2, 1) = params(21);
  homography_params_(2, 2) = params(22);
  return true;
}
