...
DEFINE_string(map_dir, "/apollo/map/data/demo",
...
DEFINE_string(vehicle_config_path,
              "/apollo/common/data/vehicle_param.pb.txt",
              "the file path of vehicle config file");


DEFINE_string(mc_camera_perception_filename,
              "mc_camera_perception.conf",
              "the file path of mc camera perception config file");
DEFINE_string(mc_radar_perception_filename,
              "mc_radar_perception.conf",
              "the file path of mc radar perception config file");
DEFINE_string(mc_fusion_filename,
              "mc_fusion.conf",
              "the file path of mc camera perception config file");
DEFINE_string(mc_perception_visualize_filename,
              "mc_visualize.conf",
              "the file path of mc camera perception config file");   
DEFINE_string(mc_traffic_light_filename,
              "mc_traffic_light.conf",
              "the file path of mc camera perception config file");   

DEFINE_string(
    vehicle_model_config_filename,
    "/apollo/common/vehicle_model/conf/vehicle_model_config.pb.txt",
