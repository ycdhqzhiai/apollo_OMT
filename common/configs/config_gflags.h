...
DECLARE_string(mc_camera_perception_filename);
DECLARE_string(mc_radar_left_perception_filename);
DECLARE_string(mc_radar_right_perception_filename);
DECLARE_string(mc_radar_perception_filename);
DECLARE_string(mc_fusion_filename);
DECLARE_string(mc_perception_visualize_filename);
DECLARE_string(mc_traffic_light_filename);
