 ...
 *****************************************************************************/
#include "common/geometry/roi_filter.h"
...
std::vector<std::size_t> ObjectInRoiIndex(const HdmapStructConstPtr roi,
                                    const std::vector<ObjectPtr>& objects) {
