...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_localization_2eproto[3];
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_localization_2eproto_sccs[3] = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_localization_2eproto = {
  false, false, descriptor_table_protodef_localization_2eproto, "localization.proto", 1158,
  &descriptor_table_localization_2eproto_once, descriptor_table_localization_2eproto_sccs, descriptor_table_localization_2eproto_deps, 3, 5,
...
static bool dynamic_init_dummy_localization_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_localization_2eproto)), true);
namespace apollo {
namespace localization {
