...
extern PROTOBUF_INTERNAL_EXPORT_map_5fgeometry_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_CurveSegment_map_5fgeometry_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_map_5fgeometry_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_LineSegment_map_5fgeometry_2eproto;
namespace apollo {
namespace hdmap {
...
static void InitDefaultsscc_info_Curve_map_5fgeometry_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_Curve_map_5fgeometry_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_Curve_map_5fgeometry_2eproto}, {
      &scc_info_CurveSegment_map_5fgeometry_2eproto.base,}};

static void InitDefaultsscc_info_CurveSegment_map_5fgeometry_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_CurveSegment_map_5fgeometry_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_CurveSegment_map_5fgeometry_2eproto}, {
      &scc_info_LineSegment_map_5fgeometry_2eproto.base,
      &scc_info_PointENU_geometry_2eproto.base,}};

static void InitDefaultsscc_info_LineSegment_map_5fgeometry_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_LineSegment_map_5fgeometry_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_LineSegment_map_5fgeometry_2eproto}, {
      &scc_info_PointENU_geometry_2eproto.base,}};

static void InitDefaultsscc_info_Polygon_map_5fgeometry_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_Polygon_map_5fgeometry_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_Polygon_map_5fgeometry_2eproto}, {
      &scc_info_PointENU_geometry_2eproto.base,}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_map_5fgeometry_2eproto[4];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_map_5fgeometry_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_map_5fgeometry_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_map_5fgeometry_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_map_5fgeometry_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_map_5fgeometry_2eproto_deps[1] = {
  &::descriptor_table_geometry_2eproto,
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_map_5fgeometry_2eproto_sccs[4] = {
  &scc_info_Curve_map_5fgeometry_2eproto.base,
  &scc_info_CurveSegment_map_5fgeometry_2eproto.base,
  &scc_info_LineSegment_map_5fgeometry_2eproto.base,
  &scc_info_Polygon_map_5fgeometry_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_map_5fgeometry_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_map_5fgeometry_2eproto = {
  false, false, descriptor_table_protodef_map_5fgeometry_2eproto, "map_geometry.proto", 385,
  &descriptor_table_map_5fgeometry_2eproto_once, descriptor_table_map_5fgeometry_2eproto_sccs, descriptor_table_map_5fgeometry_2eproto_deps, 4, 1,
  schemas, file_default_instances, TableStruct_map_5fgeometry_2eproto::offsets,
  file_level_metadata_map_5fgeometry_2eproto, 4, file_level_enum_descriptors_map_5fgeometry_2eproto, file_level_service_descriptors_map_5fgeometry_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_map_5fgeometry_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_map_5fgeometry_2eproto)), true);
namespace apollo {
namespace hdmap {
...
void Polygon::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Polygon_map_5fgeometry_2eproto.base);
}
...
void LineSegment::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_LineSegment_map_5fgeometry_2eproto.base);
}
...
void CurveSegment::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_CurveSegment_map_5fgeometry_2eproto.base);
...
void Curve::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Curve_map_5fgeometry_2eproto.base);
}
