...
extern PROTOBUF_INTERNAL_EXPORT_map_5fgeometry_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_Curve_map_5fgeometry_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_map_5fid_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Id_map_5fid_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_map_5flane_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_LaneBoundary_map_5flane_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_map_5flane_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_LaneBoundaryType_map_5flane_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_map_5flane_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_LaneSampleAssociation_map_5flane_2eproto;
namespace apollo {
namespace hdmap {
...
static void InitDefaultsscc_info_Lane_map_5flane_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<4> scc_info_Lane_map_5flane_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 4, 0, InitDefaultsscc_info_Lane_map_5flane_2eproto}, {
      &scc_info_Id_map_5fid_2eproto.base,
      &scc_info_Curve_map_5fgeometry_2eproto.base,
      &scc_info_LaneBoundary_map_5flane_2eproto.base,
      &scc_info_LaneSampleAssociation_map_5flane_2eproto.base,}};

static void InitDefaultsscc_info_LaneBoundary_map_5flane_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_LaneBoundary_map_5flane_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_LaneBoundary_map_5flane_2eproto}, {
      &scc_info_Curve_map_5fgeometry_2eproto.base,
      &scc_info_LaneBoundaryType_map_5flane_2eproto.base,}};

static void InitDefaultsscc_info_LaneBoundaryType_map_5flane_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_LaneBoundaryType_map_5flane_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_LaneBoundaryType_map_5flane_2eproto}, {}};

static void InitDefaultsscc_info_LaneSampleAssociation_map_5flane_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_LaneSampleAssociation_map_5flane_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_LaneSampleAssociation_map_5flane_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_map_5flane_2eproto[4];
static const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* file_level_enum_descriptors_map_5flane_2eproto[4];
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_map_5flane_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_map_5flane_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
const char descriptor_table_protodef_map_5flane_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "CTION\020\003"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_map_5flane_2eproto_deps[2] = {
  &::descriptor_table_map_5fgeometry_2eproto,
  &::descriptor_table_map_5fid_2eproto,
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_map_5flane_2eproto_sccs[4] = {
  &scc_info_Lane_map_5flane_2eproto.base,
  &scc_info_LaneBoundary_map_5flane_2eproto.base,
  &scc_info_LaneBoundaryType_map_5flane_2eproto.base,
  &scc_info_LaneSampleAssociation_map_5flane_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_map_5flane_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_map_5flane_2eproto = {
  false, false, descriptor_table_protodef_map_5flane_2eproto, "map_lane.proto", 1727,
  &descriptor_table_map_5flane_2eproto_once, descriptor_table_map_5flane_2eproto_sccs, descriptor_table_map_5flane_2eproto_deps, 4, 2,
  schemas, file_default_instances, TableStruct_map_5flane_2eproto::offsets,
  file_level_metadata_map_5flane_2eproto, 4, file_level_enum_descriptors_map_5flane_2eproto, file_level_service_descriptors_map_5flane_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_map_5flane_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_map_5flane_2eproto)), true);
namespace apollo {
namespace hdmap {
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* LaneBoundaryType_Type_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_map_5flane_2eproto);
  return file_level_enum_descriptors_map_5flane_2eproto[0];
}
...
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* Lane_LaneType_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_map_5flane_2eproto);
  return file_level_enum_descriptors_map_5flane_2eproto[1];
}
...
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* Lane_LaneTurn_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_map_5flane_2eproto);
  return file_level_enum_descriptors_map_5flane_2eproto[2];
}
...
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* Lane_LaneDirection_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_map_5flane_2eproto);
  return file_level_enum_descriptors_map_5flane_2eproto[3];
}
...
const LaneBoundaryType& LaneBoundaryType::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_LaneBoundaryType_map_5flane_2eproto.base);
...
void LaneBoundary::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_LaneBoundary_map_5flane_2eproto.base);
...
const LaneSampleAssociation& LaneSampleAssociation::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_LaneSampleAssociation_map_5flane_2eproto.base);
  return *internal_default_instance();
}
...
void Lane::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Lane_map_5flane_2eproto.base);
  ::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
