...
extern PROTOBUF_INTERNAL_EXPORT_omt_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_KalmanParam_omt_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_omt_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ReferenceParam_omt_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_omt_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_TargetParam_omt_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_omt_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_WeightParam_omt_2eproto;
namespace apollo {
...
static void InitDefaultsscc_info_KalmanParam_omt_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_KalmanParam_omt_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_KalmanParam_omt_2eproto}, {}};

static void InitDefaultsscc_info_OmtParam_omt_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<3> scc_info_OmtParam_omt_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 3, 0, InitDefaultsscc_info_OmtParam_omt_2eproto}, {
      &scc_info_WeightParam_omt_2eproto.base,
      &scc_info_TargetParam_omt_2eproto.base,
      &scc_info_ReferenceParam_omt_2eproto.base,}};

static void InitDefaultsscc_info_ReferenceParam_omt_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ReferenceParam_omt_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_ReferenceParam_omt_2eproto}, {}};

static void InitDefaultsscc_info_TargetParam_omt_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_TargetParam_omt_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_TargetParam_omt_2eproto}, {
      &scc_info_KalmanParam_omt_2eproto.base,}};

static void InitDefaultsscc_info_WeightParam_omt_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_WeightParam_omt_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_WeightParam_omt_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_omt_2eproto[5];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_omt_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_omt_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_omt_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
const char descriptor_table_protodef_omt_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_omt_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_omt_2eproto_sccs[5] = {
  &scc_info_KalmanParam_omt_2eproto.base,
  &scc_info_OmtParam_omt_2eproto.base,
  &scc_info_ReferenceParam_omt_2eproto.base,
  &scc_info_TargetParam_omt_2eproto.base,
  &scc_info_WeightParam_omt_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_omt_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_omt_2eproto = {
  false, false, descriptor_table_protodef_omt_2eproto, "omt.proto", 2229,
  &descriptor_table_omt_2eproto_once, descriptor_table_omt_2eproto_sccs, descriptor_table_omt_2eproto_deps, 5, 0,
  schemas, file_default_instances, TableStruct_omt_2eproto::offsets,
  file_level_metadata_omt_2eproto, 5, file_level_enum_descriptors_omt_2eproto, file_level_service_descriptors_omt_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_omt_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_omt_2eproto)), true);
namespace apollo {
namespace perception {
namespace camera {
namespace omt {
...
const KalmanParam& KalmanParam::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_KalmanParam_omt_2eproto.base);
...
void TargetParam::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_TargetParam_omt_2eproto.base);
  ::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
...
const ReferenceParam& ReferenceParam::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_ReferenceParam_omt_2eproto.base);
  return *internal_default_instance();
}
...
const WeightParam& WeightParam::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_WeightParam_omt_2eproto.base);
  return *internal_default_instance();
}
...
void OmtParam::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_OmtParam_omt_2eproto.base);
  type_change_cost_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  ::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
...
void OmtParam::InternalSwap(OmtParam* other) {
  ...
  _internal_metadata_.Swap<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(&other->_internal_metadata_);
  swap(_has_bits_[0], other->_has_bits_[0]);
  type_change_cost_.Swap(&other->type_change_cost_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
