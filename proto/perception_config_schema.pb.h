...
class KeyValueInt PROTOBUF_FINAL :
...
class KeyValueString PROTOBUF_FINAL :
...
class KeyValueDouble PROTOBUF_FINAL :
...
class KeyValueFloat PROTOBUF_FINAL :
...
class KeyValueBool PROTOBUF_FINAL :
...
class KeyValueArrayInt PROTOBUF_FINAL :
...
class KeyValueArrayString PROTOBUF_FINAL :
...
class KeyValueArrayDouble PROTOBUF_FINAL :
...
class KeyValueArrayFloat PROTOBUF_FINAL :
...
class KeyValueArrayBool PROTOBUF_FINAL :
...
class ModelConfigProto PROTOBUF_FINAL :
...
class MultiModelConfigProto PROTOBUF_FINAL :
...
class ModelConfigFileListProto PROTOBUF_FINAL :
...
inline void KeyValueString::set_value(const void* value,
    size_t size) {
  _has_bits_[0] |= 0x00000002u;
