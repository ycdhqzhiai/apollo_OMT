...
static void InitDefaultsscc_info_SemanticReviseParam_semantic_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_SemanticReviseParam_semantic_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_SemanticReviseParam_semantic_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_semantic_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_semantic_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_semantic_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_semantic_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
const char descriptor_table_protodef_semantic_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\016semantic.proto\022.apollo.perception.came"
  "ra.traffic_light.tracker\"\202\001\n\023SemanticRev"
  "iseParam\022\037\n\022revise_time_second\030\001 \001(\002:\0031."
  "5\022#\n\026blink_threshold_second\030\002 \001(\002:\0030.4\022%"
  "\n\032hysteretic_threshold_count\030\003 \001(\005:\0012"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_semantic_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_semantic_2eproto_sccs[1] = {
  &scc_info_SemanticReviseParam_semantic_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_semantic_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_semantic_2eproto = {
  false, false, descriptor_table_protodef_semantic_2eproto, "semantic.proto", 197,
  &descriptor_table_semantic_2eproto_once, descriptor_table_semantic_2eproto_sccs, descriptor_table_semantic_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_semantic_2eproto::offsets,
  file_level_metadata_semantic_2eproto, 1, file_level_enum_descriptors_semantic_2eproto, file_level_service_descriptors_semantic_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_semantic_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_semantic_2eproto)), true);
namespace apollo {
namespace perception {
namespace camera {
namespace traffic_light {
...
const SemanticReviseParam& SemanticReviseParam::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_SemanticReviseParam_semantic_2eproto.base);
    ...
    if (cached_has_bits & 0x00000001u) {
      total_size += 1 +
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32Size(
          this->_internal_hysteretic_threshold_count());
    }
